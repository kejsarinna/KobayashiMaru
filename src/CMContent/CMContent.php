    ...
    switch($action) {
      case 'install': 
        try {
          ...
          $this->db->ExecuteQuery(self::SQL('insert content'), array('home', 'page', 'Home page', "This is a demo page, this could be your personal home-page.\n\nKobayashi Maru is a PHP-based MVC-inspired Content management Framework, watch the making of Lydia, the framework Kobayashi Maru is based on, at: http://dbwebb.se/lydia/tutorial.", 'plain', $this->user['id']));
          $this->db->ExecuteQuery(self::SQL('insert content'), array('about', 'page', 'About page', "This is a demo page, this could be your personal about-page.\n\nKobayashi Maru is used as a tool to educate in MVC frameworks.", 'plain', $this->user['id']));
