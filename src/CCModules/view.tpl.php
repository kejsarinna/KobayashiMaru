...
<tbody>
  <tr><td>Part of Kobayashi Maru Core modules</td><td><?=$module['isKobayashiCore']?'Yes':'No'?></td></tr>
  <tr><td>Part of Kobayashi Maru CMF modules</td><td><?=$module['isKobayashiCMF']?'Yes':'No'?></td></tr>
